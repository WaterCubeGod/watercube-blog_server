...
type CommentModel struct {
	...
	ParentCommentModel *CommentModel   `gorm:"foreignKey:ParentCommentID" json:"comment_comments"` // 父级评论
	...
	User               UserModel       `json:"user" gorm:"-"`                                      // 关联的用户
	UseID              uint            `json:"user_id"`                                            // 评论的用户
}
